...
>
> 本稿中的 1.0 文本从未作为现行发行协议生效，现已由随 App 分发的双语 1.1 文本取代。它不对 Apache License 2.0 或任何第三方自由及开源许可证授予的权利增加限制。
>
...
如您对本协议、本应用功能或数据处理方式有疑问、意见或权利请求，可通过您获取本应用的发布平台所列开发者渠道联系，或前往项目维护页面查看最新公开信息：<https://github.com/mekwenby/TokenFlowApp>。
